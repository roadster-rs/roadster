...
//!
//! Expects to be run after [crate::migration::sea_orm::timestamp::m20240723_201404_add_update_timestamp_function::Migration],
//! or another equivalent [Migration].
//!
//! Note: Currently only supports Postgres. If another DB is used, will do nothing.

use crate::migration::sea_orm::timestamp::Timestamps;
