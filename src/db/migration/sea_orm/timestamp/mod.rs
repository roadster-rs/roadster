...
#[non_exhaustive]
pub enum Timestamps {
    /// When the row was created. When used with the [`crate::db::migration::sea_orm::schema::timestamps`] method, will default to
    /// the current timestamp (with timezone).
    CreatedAt,
    /// When the row was updated. When used with the [`crate::db::migration::sea_orm::schema::timestamps`] method, will be initially set to
    /// the current timestamp (with timezone).
    ///
    ...
    /// the [`crate::db::migration::sea_orm::timestamp`] module. Specifically, see:
...
/// # Examples
/// ```rust
/// use roadster::db::migration::sea_orm::timestamp::Timestamps;
/// use roadster::db::migration::sea_orm::timestamp::exec_create_update_timestamp_function;
/// use sea_orm_migration::prelude::*;
///
...
/// ```rust
/// use roadster::db::migration::sea_orm::timestamp::Timestamps;
/// use roadster::db::migration::sea_orm::timestamp::{exec_create_update_timestamp_function_dep_column};
/// use sea_orm_migration::prelude::*;
///
/// #[derive(DeriveMigrationName)]
/// pub struct Migration;
...
/// ```rust
/// use roadster::db::migration::sea_orm::timestamp::Timestamps;
/// use roadster::db::migration::sea_orm::timestamp::exec_drop_update_timestamp_function;
/// use sea_orm_migration::prelude::*;
///
/// #[derive(DeriveMigrationName)]
/// pub struct Migration;
...
/// ```rust
/// use roadster::db::migration::sea_orm::timestamp::Timestamps;
/// use roadster::db::migration::sea_orm::timestamp::exec_create_update_timestamp_trigger;
/// use sea_orm_migration::prelude::*;
///
/// #[derive(DeriveMigrationName)]
/// pub struct Migration;
...
/// ```rust
/// use roadster::db::migration::sea_orm::timestamp::Timestamps;
/// use roadster::db::migration::sea_orm::timestamp::exec_drop_update_timestamp_trigger;
/// use sea_orm_migration::prelude::*;
///
/// #[derive(DeriveMigrationName)]
/// pub struct Migration;
...
#[cfg(test)]
mod tests {
    use crate::db::migration::sea_orm::timestamp::{FnQueryStrings, TriggerQueryNames};
