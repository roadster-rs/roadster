...
pub struct DbSeaOrmMigrationLifecycleHandler;

#[async_trait]
impl<A, S> AppLifecycleHandler<A, S> for DbSeaOrmMigrationLifecycleHandler
where
...
mod tests {
    ...
    fn enabled(
        ...
        let handler = DbSeaOrmMigrationLifecycleHandler;
