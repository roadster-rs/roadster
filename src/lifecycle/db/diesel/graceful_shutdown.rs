...
pub struct DbDieselGracefulShutdownLifecycleHandler;

#[async_trait]
impl<A, S> AppLifecycleHandler<A, S> for DbDieselGracefulShutdownLifecycleHandler
where
...
{
    fn name(&self) -> String {
        "db-diesel-graceful-shutdown".to_string()
    }
...
mod tests {
    ...
    fn enabled(
        ...
        let handler = DbDieselGracefulShutdownLifecycleHandler;
